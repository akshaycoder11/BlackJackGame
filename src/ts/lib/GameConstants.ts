...
export class GameConstants { 
    public static PLAYER_BET_CLICKED: string = "PLAYER_BET_CLICKED";
    ...
    public static SHOW_WIN_PRESENTAION: string = "SHOW_WIN_PRESENTAION";
    public static UPDATE_PLAYER_DEALER_MTR: string = "UPDATE_PLAYER_DEALER_MTR";
    public static DRAW_FIRST_CARD: string = "DRAW_FIRST_CARD";
    public static CHECK_WIN_LOGIC: string = "CHECK_WIN_LOGIC";
    public static RESET_ALL: string = "RESET_ALL";
}